...
public class StepDetector {
    ...
    public void registerListener(StepsCounter listener) {
    ...
    public void updateAccel(long timeNs, float x, float y, float z) {
        ...
        if (velocityEstimate > STEP_THRESHOLD /*&& velocityEstimate < STEP_THRESHOLD+20f */&& oldVelocityEstimate <= STEP_THRESHOLD
